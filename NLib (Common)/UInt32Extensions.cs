...
namespace NLib
{
    ...
    public static class UInt32Extensions
    {
        ...
        /// <summary>
        ///     Gets the 16 high-order bits of the specified UInt32.
        /// </summary>
        /// <param name="value">
        ...
        /// <summary>
        ///     Gets the 16 low-order bits of the specified UInt32.
        /// </summary>
        /// <param name="value">
        ///     The System.UInt32 to get the bits from.
        /// </param>
        ...
        /// <summary>
        ///     Rotates the bits of the specified UInt32 right. A parameter
        ///     specifies the number of places to rotate the bits by.
        /// </summary>
        /// <param name="value">
        ///     The UInt32 to rotate.
        /// </param>
        /// <param name="count">
        ///     The number of places to rotate the bits by.
        /// </param>
        /// <returns>
        ///     A UInt32 containing the rotated bits.
        /// </returns>
        ...
        /// <summary>
        ///     Rotates the bits of the specified UInt32 left. A parameter
        ///     specifies the number of places to rotate the bits by.
        /// </summary>
        /// <param name="value">
        ///     The UInt32 to rotate.

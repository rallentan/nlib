...
{
    namespace IndexOfAny_String_CharArray_Int32_Int32_StringComparison
    {
        public class Root0
        {
            //--- Constants ---
            ...
            {
                return StringExtensions.IndexOfAny(source, anyOf, startIndex, length, comparisonType);
            }
        ...
        namespace When_comparisonType_is_CurrentCulture
        {
            ...
            public class Root1
            {
                ...
                {
                    int result = Root0.TestedMethodAdapter(Root0.SOURCE_STRING, Root0.EMPTY_CHAR_ARRAY, 0, 4, COMPARISON_TYPE);
                    Assert.AreEqual(-1, result);
                }

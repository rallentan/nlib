...
{
    namespace LastIndexOfAny_String_CharArray_Int32_Int32_StringComparison
    {
        public class Root0
...
#endif
        {
            ...
            {
                return StringExtensions.LastIndexOfAny(source, anyOf, startIndex, count, comparisonType);
            }
        }
...
#if OVERLOAD_HAS_STARTINDEX_PARAM
#if OVERLOAD_HAS_COUNT_PARAM
                : Root1Base_LastOfAny_with_startIndex_and_count
#else
                : Root1Base_LastOfAny_with_startIndex_Without_count
#endif
#else
                : Root1Base_OfAny
#endif

...
{
    namespace LastIndexOfNotAny_String_CharArray_Int32_Int32_StringComparison
    {
        public class Root0
        {
            //--- Constants ---
            ...
            public const string SOURCE_STRING_FOR_CHARARRAY_LENGTH_1_NO_MATCH = "aooooooooox";
            ...
            public const string SOURCE_STRING_FOR_CHARARRAY_LENGTH_1_NO_MATCH = "oooooooooox";
            public const int CORRECT_RESULT = 1;
            public const int INNER_RANGE_START = 9;
            public const int INNER_RANGE_LENGTH = -1;
#else
            public const string SOURCE_STRING = "oxooooooooo";
            public const string SOURCE_STRING_FOR_CHARARRAY_LENGTH_1_NO_MATCH = "ooooooooooo";
            public const int CORRECT_RESULT = 1;
            public const int INNER_RANGE_START = 10;
            public const int INNER_RANGE_LENGTH = -1;
#endif
#endif
            ...
            {
                return StringExtensions.LastIndexOfNotAny(source, anyOf, startIndex, length, comparisonType);
            }

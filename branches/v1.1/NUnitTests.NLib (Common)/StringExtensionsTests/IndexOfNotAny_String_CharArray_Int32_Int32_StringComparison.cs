...
{
    namespace IndexOfNotAny_String_CharArray_Int32_Int32_StringComparison
    {
        public class Root0
        {
            //--- Constants ---
            ...
            {
                return StringExtensions.IndexOfNotAny(source, anyOf, startIndex, length, comparisonType);
            }

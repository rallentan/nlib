...
{
    [TestFixture]
    class LastIndexOfNotAny_String_CharArray_Int32
    {
        //--- Constants ---
        ...
        [Theory]
        public void When_anyOf_is_empty_and_source_is_not_empty_returns_startIndex()
        {
            int result = TestedMethodAdapter(SIMPLE_STRING, EMPTY_CHAR_ARRAY, 0);
        ...
        {
            TestedMethodAdapter(LENGTH_4_STRING, EMPTY_CHAR_ARRAY, 4);
        }

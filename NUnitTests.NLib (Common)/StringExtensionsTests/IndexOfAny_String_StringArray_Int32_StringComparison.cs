...
{
    namespace IndexOfAny_String_StringArray_Int32_StringComparison
    {
        public class Root0
        {
            //--- Constants ---
            ...
            public static int TestedMethodAdapter(string source, string[] anyOf, int startIndex, int length, StringComparison comparisonType)
            {
                return StringExtensions.IndexOfAny(source, anyOf, startIndex, comparisonType);
            }

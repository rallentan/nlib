...
{
    [TestFixture]
    class IndexOfAny_String_StringArray_Int32_StringComparison
    {
        //--- Constants ---
        ...
        static int TestedMethodAdapter(string source, string[] anyOf, int startIndex, int unused1, StringComparison comparisonType)
        {

...
{
    [TestFixture]
    class IndexOfAny_String_StringArray_Int32
    {
        //--- Constants ---
        ...
        static int TestedMethodAdapter(string source, string[] anyOf, int startIndex, int unused1, StringComparison unused2)
        {
